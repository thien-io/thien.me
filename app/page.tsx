      ...
      <div className='content-wrap'>
          ...
          <>
            <section className='px-8 md:px-16 py-16 md:py-24'>
              <ScrollReveal>
                ...
                <h2 className='font-heading uppercase text-4xl md:text-5xl leading-[0.9] text-foreground mb-10'>
                  What players say.
                </h2>
              </ScrollReveal>
        ...
        <section className='px-8 md:px-16 py-16 md:py-24'>
          <ScrollReveal>
            ...
            <h2 className='font-heading uppercase text-4xl md:text-5xl leading-[0.9] text-foreground mb-4'>
              Get in touch.
            </h2>
            ...
            <div className='flex flex-row gap-3'>
              ...
              <a
                ...
                className='inline-flex items-center px-3 py-2.5 rounded-full border border-border bg-card text-foreground hover:border-primary/50 hover:text-primary transition-all'
              >
                <svg viewBox='0 0 24 24' className='w-4 h-4' fill='none' stroke='currentColor' strokeWidth='1.5'>
              ...
              <a
                ...
                aria-label='Venmo'
                className='inline-flex items-center px-3 py-2.5 rounded-full border border-border bg-card hover:border-[#3D95CE]/40 hover:bg-[#3D95CE]/5 transition-all'
              >

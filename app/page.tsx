          ...
          <ScrollReveal>
            ...
            <div className='flex flex-row gap-3'>
              ...
              <a
                ...
                className='inline-flex items-center px-3 py-2.5 border border-border bg-card text-foreground hover:border-primary/50 hover:text-primary transition-all'
              >
                <svg viewBox='0 0 24 24' className='w-4 h-4' fill='none' stroke='currentColor' strokeWidth='1.5'>
              ...
              <a
                ...
                aria-label='Venmo'
                className='inline-flex items-center px-3 py-2.5 border border-border bg-card hover:border-[#3D95CE]/40 hover:bg-[#3D95CE]/5 transition-all'
              >

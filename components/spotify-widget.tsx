...
export function SpotifyWidget() {
  ...
  if (!data) {
    return (
      <div className="h-16 rounded-md border border-border bg-muted animate-pulse" />
    );
  }
  ...
  return (
    <a
      ...
      className="flex items-center gap-3 p-4 rounded-md border border-border bg-card transition-colors hover:border-primary/50 group"
    >
      {data.albumArt && (
        <Image
          src={data.albumArt}

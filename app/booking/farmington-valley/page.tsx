      ...
      <section className="px-8 md:px-16 pt-24 pb-8 md:pt-24 md:pb-10">
        ...
        <ScrollReveal delay={160}>
          <p className="text-muted-foreground leading-relaxed max-w-md">
            I&apos;ll be coaching at Farmington Valley Racquet Club this season — but booking
        ...
        <ScrollReveal delay={80}>
          <div className="space-y-5">
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Farmington Valley Racquet Club is a premier indoor facility in Farmington, CT.
                Sessions here will be available for all levels — from beginner clinics to
                competitive match prep.
              </p>
            </div>

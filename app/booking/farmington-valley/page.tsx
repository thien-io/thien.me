...
export default function BookingFarmingtonPage() {
  return (
    <div>
      <section className='px-8 md:px-16 pt-28 pb-8 md:pt-24 md:pb-10'>
        ...
        <ScrollReveal delay={160}>
          <p className='text-muted-foreground leading-relaxed max-w-md'>
            I&apos;ll be coaching at Farmington Valley Racquet Club this season
            — but booking isn&apos;t open yet. This location is currently off
            season and no times are available to schedule right now.
          </p>
        </ScrollReveal>
      </section>
            ...
            <div className='flex items-start gap-4'>
              ...
              <div>
                ...
                <p className='text-sm text-muted-foreground leading-relaxed'>
                  No times are available at this location right now. Check back
                  once the season kicks off — the calendar will go live here as
                  soon as sessions are available to book.
                </p>
              </div>
            </div>
          </div>
        ...
        <ScrollReveal delay={80}>
          <div className='space-y-5'>
            <div>
              ...
              <p className='text-sm text-muted-foreground leading-relaxed'>
                Farmington Valley Racquet Club is a premier indoor facility in
                Farmington, CT. Sessions here will be available for all levels —
                from beginner clinics to competitive match prep.
              </p>
            </div>
            ...
            <div>
              ...
              <p className='text-sm text-muted-foreground leading-relaxed mb-3'>
                Reach out directly and I&apos;ll let you know as soon as the
                schedule opens up.
              </p>
              <a
            ...
            <div className='flex flex-col gap-3'>
              ...
              >
                <div>
                  ...
                  <p className='font-mono text-[10px] text-muted-foreground/60 mt-0.5'>
                    Torrington, CT · Tennis · Pickleball
                  </p>
                </div>
                <span className='font-mono text-[10px] text-primary'>
                  Book →

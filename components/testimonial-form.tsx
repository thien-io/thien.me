    ...
    <form onSubmit={handleSubmit} className="space-y-4 max-w-md">
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-4 py-2.5 rounded-md border border-border bg-card text-sm text-foreground leading-relaxed focus:outline-none focus:border-primary transition-colors resize-none"
        />
      </div>

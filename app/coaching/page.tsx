    ...
    <div>
      <section className="relative px-8 md:px-16 pt-10 pb-10 md:pt-32 md:pb-20 overflow-hidden">
        ...
        <ScrollReveal>
          ...
          <h1 className="font-heading uppercase text-5xl md:text-6xl leading-[0.9] tracking-[0.01em] mb-6">
            Work with<br /><em className="text-primary not-italic">me.</em>
          </h1>
      ...
      <section className="px-8 md:px-16 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-xl">
          <ScrollReveal>
            <Link href="/pricing" className="block group p-8 rounded-md border border-border bg-card transition-colors hover:border-primary/50">
              ...
              <h2 className="font-heading uppercase text-3xl md:text-4xl leading-[0.9] tracking-[0.01em] text-foreground group-hover:text-primary transition-colors mb-2">
                Tennis
              </h2>
